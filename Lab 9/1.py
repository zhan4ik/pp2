...
background = pygame.image.load("Lab 9\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Lab 9\Enemy.png")
...
class Point(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Lab 9\coin.png")
    ...
    def move(self):
        ...
        # Silver 5 points coin
            ...
            self.image = pygame.image.load("Lab 9\coin2.png")
            self.image = pygame.transform.scale(self.image, (50, 50))
            COIN_VALUE = 5
        # Secret 1% coin
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Lab 9\Player.png")
        self.image = pygame.transform.scale(self.image, (100, 120))
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        sound = pygame.mixer.Sound('Lab 9\crash.mp3')
